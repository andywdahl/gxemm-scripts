...
#$ -o Rout/rnm			#-- output directory (fill in)
#$ -e Rout/rnm                     #-- error directory (fill in)
...
#$ -l h_rt=28:20:00                #-- runtime limit (see above; this requests 24 hours)
#$ -t 1-200													#-- remove first '#' to specify the number of

date
hostname

Rscript run_rnm.R $SGE_TASK_ID
