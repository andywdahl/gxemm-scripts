...
#$ -o Rout/mainout			#-- output directory (fill in)
...
#$ -l mem_free=14G                  #-- submits on nodes with enough free memory (required)
#$ -l h_rt=48:20:00                #-- runtime limit (see above; this requests 24 hours)
