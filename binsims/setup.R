...
ltys			<- c(  1						,1						, 1								) #, 1					
cols1			<- c( 'grey'				,'orange'			, 4								) #, 5					
testnames	<- c( 'hom'					,'iid'				, 'diag2' 				) #, 'h2eq'		
testlabs	<- c( 'Hom vs Null'	,'IID vs Hom'	, 'Free vs Hom G'	) #, 'Equal h2'
...
xlabs	<- expression( h[hom]^2, h[het]^2, sigma[2]^2, omega, w[2] )
